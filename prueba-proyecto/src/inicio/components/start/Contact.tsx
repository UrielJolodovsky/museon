...
const Contacto = () => {
  ...
  return (
    ...
    <div className='flex w-full h-[500px] xl:w-full lg:w-full md:w-full sm:w-full lg:h-[550px] md:h-[450px] sm:h-[550px] justify-center items-center lg:flex-col md:flex-col sm:flex-col sm:gap-4'>
      <div className='flex w-1/4 xl:w-1/3 lg:w-full md:w-full sm:w-full h-[400px] lg:h-2/3 md:h-[400px] sm:h-2/3 justify-center items-center flex-col gap-4'>
