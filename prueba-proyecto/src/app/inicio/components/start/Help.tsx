...
const Help = () => {
  return (
    <section className='w-full h-[300px] lg:h-[550px] flex justify-center items-center flex-col mb-28 lg:m-0'>
      <div className='w-full flex justify-center items-center flex-row md:flex-col'>
        <div className='w-1/3 lg:w-full flex justify-center items-center flex-col gap-2 pt-20 lg:ml-0'>
