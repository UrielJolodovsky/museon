...
const Help = () => {
  return (
    <section className='w-full h-[400px] md:h-[200px] flex justify-center items-center flex-col pt-10'>
      <div className='w-full md:w-2/3 flex justify-center items-center flex-col md:flex-row gap-2'>
        <div className='w-full h-1/3 md:w-1/2 md:h-full flex justify-center items-center flex-col gap-2 px-8 md:px-0'>
