  ...
  return (
    <section className='w-full h-[300px] lg:h-[450px] md:h-[450px] flex justify-center items-center flex-row lg:flex-col'>
      <div className='flex justify-center items-center w-full h-full lg:flex-col'>
        <div className='w-1/3 lg:w-full md:w-full lg:h-1/2 h-full flex flex-col justify-center items-center gap-2'>
        ...
        <div className='w-1/3 h-full lg:w-full lg:h-1/2 lg:justify-center flex justify-center items-center'>
